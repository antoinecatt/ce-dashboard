...
class Temperature extends Component {
  ...
  //     let temp = currentState.series[0];
  //     //this.props.handleUpdateDevice(this.props.id, temp);
  //     return { series: [++temp] };
  //   });
  // };
  ...
  // clickDownHandler = () => {
  //   this.setState(currentState => {
  //     return { series: [currentState.series[0] - 1] };
  //   });
  // };
    ...
    return (
      <Col lg="12" xl="6">
        ...
        <Card body>
          <button
            onClick={event =>
              this.props.handleDeleteDevice(this.props.id, event)
            }
            className="delete"
          />
